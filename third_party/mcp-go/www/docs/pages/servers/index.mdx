...
- **[Completions](/servers/completions)** - Argument auto-completion for prompts and resources
- **[Elicitation](/servers/elicitation)** - Requesting additional user input during interactions
