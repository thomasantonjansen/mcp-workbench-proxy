...
// JSONRPCErrorDetailsError retains an upstream JSON-RPC error as a Go error.
// Callers can wrap it without losing the protocol code or data payload.
type JSONRPCErrorDetailsError struct {
	Details JSONRPCErrorDetails
}

func (e *JSONRPCErrorDetailsError) Error() string {
	return e.Details.Message
}

func (e *JSONRPCErrorDetailsError) JSONRPCErrorDetails() JSONRPCErrorDetails {
	return e.Details
}

func (e *JSONRPCErrorDetailsError) Unwrap() error {
	return e.Details.AsError()
}
